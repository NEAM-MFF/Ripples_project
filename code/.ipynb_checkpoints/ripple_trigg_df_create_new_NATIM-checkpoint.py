                ...
                for ch in range(64):
                    ...
                    if df_ch.shape[0]>0:
                        ...
                        if trigg_point in trigger_dict:
                            ...
                            only_common_peaks = df_ch[column_name].values + arr_start  # in this version we will not exclude non-common times
                        else:
                        ...
                        prop_dict = ripple_triggered_prop_NATIM(ripple_center_vec,rb_sig_vec,rb_env_vec,LFP_vec,
